...
{
    public partial class EditStdNarrationMaster
    {
        [Inject]
        ...
        {
            stdNarrationMaster = await PostgresService.GetStdNarrationMasterByMasterId(masterId:MasterId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await PostgresService.UpdateStdNarrationMaster(masterId:MasterId, stdNarrationMaster);
