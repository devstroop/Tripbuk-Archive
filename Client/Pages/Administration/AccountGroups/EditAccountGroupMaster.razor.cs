...
{
    public partial class EditAccountGroupMaster
    {
        [Inject]
        ...
        {
            accountGroupMaster = await PostgresService.GetAccountGroupMasterByMasterId(masterId:MasterId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await PostgresService.UpdateAccountGroupMaster(masterId:MasterId, accountGroupMaster);
