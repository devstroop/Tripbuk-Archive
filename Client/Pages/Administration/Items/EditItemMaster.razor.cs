...
{
    public partial class EditItemMaster
    {
        [Inject]
        ...
        {
            itemMaster = await PostgresService.GetItemMasterByMasterId(masterId:MasterId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await PostgresService.UpdateItemMaster(masterId:MasterId, itemMaster);
