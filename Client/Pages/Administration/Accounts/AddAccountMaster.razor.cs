...
{
    public partial class AddAccountMaster
    {
        [Inject]
        ...
        {
            accountMaster = new ERP.Server.Models.Postgres.AccountMaster();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await PostgresService.CreateAccountMaster(accountMaster);
