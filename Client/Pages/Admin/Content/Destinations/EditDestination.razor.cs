...
{
    public partial class EditDestination
    {
        [Inject]
        ...
        {
            destination = await PostgresService.GetDestinationById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await PostgresService.UpdateDestination(id:Id, destination);
